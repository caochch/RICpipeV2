...
perl count_link_for_each_kind.pl interaction_from_pair_mapped_reads_1.sort.sam interaction_from_pair_mapped_reads_2.sort.sam interaction_from_gapped_reads.sam patientA_rep1_read1_toGenomeChimeric.out.processed.sam patientA_rep1_read2_toGenomeChimeric.out.processed.sam > num_of_interactions.list
