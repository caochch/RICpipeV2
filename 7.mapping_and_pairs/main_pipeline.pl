...
my $STAR_index_dir="/mnt/pub/work/caochch/project_My/project033_RIC_Covid19_withHost_WIV/database/Pangenome_human";
my $genome_ref_fasta="/mnt/pub/work/caochch/project_My/project033_RIC_Covid19_withHost_WIV/database/Pangenome_human/human_virus.pan.fa";
...
foreach my $d (@samples){
	...
	#print TSH "perl /media/ibm_disk/work/caochch/project_My/RICpipeV2_20210713/7.mapping_and_pairs/get_final_unmapped_reads.pl ./$d/$prefix","_read1_toGenomeUnmapped_really.fq ./$d/z1.second_round_byBWA/unmapped.1.readID.list > ./$d/z1.second_round_byBWA/read1_torRNA_Unmapped_really.FutherByBwa.fq\n";
	#print TSH "perl /media/ibm_disk/work/caochch/project_My/RICpipeV2_20210713/7.mapping_and_pairs/get_final_unmapped_reads.pl ./$d/$prefix","_read2_toGenomeUnmapped_really.fq ./$d/z1.second_round_byBWA/unmapped.2.readID.list > ./$d/z1.second_round_byBWA/read2_torRNA_Unmapped_really.FutherByBwa.fq\n";
